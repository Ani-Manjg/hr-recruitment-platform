...
export type ExtractedProfile = { name:string|null; email:string|null; phone:string|null; education:string|null; languages:string[]; location:string|null }
export type ResumeAnalysis = { matchScore:number; detectedSkills:string[]; yearsExperience:number; summary:string; strengths:string[]; weaknesses:string[]; extractedProfile:ExtractedProfile }
