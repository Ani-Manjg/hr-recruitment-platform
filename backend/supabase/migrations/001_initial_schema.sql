...
create type public.talentflow_user_role as enum ('ADMIN','RECRUITER');
create type public.talentflow_job_status as enum ('Open','Closed','Draft');
create type public.talentflow_location_type as enum ('Remote','Hybrid','On-site');
create type public.talentflow_resume_status as enum ('New','Screened','Shortlisted','Rejected','Interviewing');
create type public.talentflow_interview_type as enum ('Phone','Video','On-site');
...
create table public.users (
  ...
  phone text,
  avatar_url text,
  role public.talentflow_user_role not null default 'RECRUITER',
  created_at timestamptz not null default now(),
...
create table public.invitations (
  ...
  company_id uuid not null references public.companies(id) on delete cascade,
  email text not null,
  role public.talentflow_user_role not null,
  token_hash text not null unique,
...
create table public.jobs (
  ...
  location_type public.talentflow_location_type not null,
  required_skills text[] not null default '{}',
  required_experience text not null default '',
  education text not null default '',
  languages text[] not null default '{}',
  status public.talentflow_job_status not null default 'Draft',
...
create table public.candidates (
  ...
  resume_status public.talentflow_resume_status not null default 'New',
...
create table public.interviews (
  ...
  type public.talentflow_interview_type not null,
